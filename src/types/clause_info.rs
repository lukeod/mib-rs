...
static CLAUSE_INFO_TABLE: &[ClauseInfo] = &[
    ClauseInfo {
        name: "SYNTAX",
        macros: &["OBJECT-TYPE", "TEXTUAL-CONVENTION", "MODULE-COMPLIANCE", "AGENT-CAPABILITIES"],
        rfc: "RFC 2578",
    ...
    ClauseInfo {
        name: "STATUS",
        macros: &["OBJECT-TYPE", "MODULE-IDENTITY", "OBJECT-IDENTITY", "NOTIFICATION-TYPE", "TEXTUAL-CONVENTION", "OBJECT-GROUP", "NOTIFICATION-GROUP", "MODULE-COMPLIANCE", "AGENT-CAPABILITIES"],
        rfc: "RFC 2578",
        description: "Indicates the lifecycle state of a definition: current, deprecated, or obsolete.",
    },
    ClauseInfo {
        name: "DESCRIPTION",
        macros: &["OBJECT-TYPE", "MODULE-IDENTITY", "OBJECT-IDENTITY", "NOTIFICATION-TYPE", "TEXTUAL-CONVENTION", "OBJECT-GROUP", "NOTIFICATION-GROUP", "MODULE-COMPLIANCE", "AGENT-CAPABILITIES", "TRAP-TYPE"],
        rfc: "RFC 2578",
        description: "Provides a human-readable text description of the definition.",
    },
    ClauseInfo {
        name: "REFERENCE",
        macros: &["OBJECT-TYPE", "OBJECT-IDENTITY", "NOTIFICATION-TYPE", "TEXTUAL-CONVENTION", "OBJECT-GROUP", "NOTIFICATION-GROUP", "MODULE-COMPLIANCE", "AGENT-CAPABILITIES", "TRAP-TYPE"],
        rfc: "RFC 2578",
