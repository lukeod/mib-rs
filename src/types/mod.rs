...
//! diagnostic infrastructure ([`Diagnostic`], [`DiagnosticReport`],
//! [`DiagnosticEntry`], [`DiagCode`], [`DiagnosticConfig`]),
...
pub use diagnostic::{
    Diagnostic, DiagnosticConfig, DiagnosticEntry, DiagnosticReport, DiagnosticReportError,
};
pub use enums::{
